                        ...
                        <tr>
                            ...
                            <td>
                                {{-- <a href="{{url('/edit')}}/{{$user->id}}" type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#ModalEdit"> --}}
                                  <a href="/progresdetail" type="button" class="btn btn-primary">
                                    Detail</a>
                            </td>
                        </tr>
                        {{-- @endforeach --}}
              ...
              <div class="card-body">
                ...
                <form class="forms-sample" action="" method="POST">
                  ...
                  <div class="form-floating">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="nama" required>
                    <label for="floatingInput">Nama</label>
                  </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      <div class="form-floating">
                        ...
                        <input type="text" class="form-control" name="no_hp" id="no_hp" value="" required>
                        <label for="floatingInput">No. Handphone</label>
                  </div>
                  </div>
                  <div class="form-group">
